  ...
  public static Command handOff(Intake intake, Elevator elevator, Shoulder shoulder) {
    return Commands.sequence(
            Commands.parallel(
                ...
                Commands.waitUntil(
                        () -> elevator.getHeight() > ElevatorConstants.kElevatorHeights[0])
                    .andThen(
                        ShoulderCommands.moveShoulderTo(
                            shoulder,
                            0.75)) //// Wait until the elevator is high enough up to start rotating
                // the
                // arm down.
                ),
            Commands.parallel(
                ElevatorCommands.moveElevatorTo(
                    ...
                    ElevatorConstants.kElevatorHeights[
                        0]), // Move the elevator down to handoff height.
